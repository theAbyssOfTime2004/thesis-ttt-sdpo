"""
05_colab_qwen15b_kickoff.py

Colab L4 kickoff script:
- Qwen2.5-1.5B + LoRA
- Multi-problem, multi-step SDPO
- Reward from evaluator.evaluate_solution
"""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output_dir", type=str, default="outputs/05_colab_kickoff")
...
def main() -> None:
    ...
    if use_wandb:
        ...
        wandb.init(
            ...
            name=f"kickoff-{args.model_name.split('/')[-1]}-{args.num_problems}prob",
            config=vars(args),
        )
